package com.toavina.WebFramework.tool;
...
public class ClassLib {
    ...
    public static String getWorkingDirectory(ServletContext context){
        String workingDir = "";
        File file = new File(context.getRealPath("/WEB-INF/config/workingDir.conf"));
        try{
    ...
    *
    * */
    public static UrlMappingModel[] getAnnotations(Class[] controllers){
